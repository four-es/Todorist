...
const addItemInTodoList = ()=> {
    ...
    tasks.forEach((item) => {
        cards.innerHTML += `
                ...
                <button class="toDo__pencil-btn"><img class="toDo__pencil" src="https://cdn-icons-png.flaticon.com/512/266/266146.png" alt=""></button>
                ...
                <button data-id="${item.id}" class="toDo__trash-btn"><img class="toDo__trash" src="https://uxwing.com/wp-content/themes/uxwing/download/food-and-drinks/garbage-bag-icon.png" alt=""></button>
            </div>  
    `t
